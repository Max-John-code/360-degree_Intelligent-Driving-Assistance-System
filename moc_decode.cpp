...
QT_MOC_LITERAL(3, 16, 7), // "sendMat"
QT_MOC_LITERAL(4, 24, 3) // "Mat"

    },
    "Decode\0sendImg\0\0sendMat\0Mat"
};
...
void Decode::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendImg((*reinterpret_cast< QImage(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        ...
        {
            typedef void (Decode::*_t)(QImage , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Decode::sendImg)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Decode::*_t)(Mat );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Decode::sendMat)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Decode::sendImg(QImage _t1, int _t2)
{
